...
export default function Header(props) {
  return (
    <header className="p-4 bg-coolGray-100 text-coolGray-800 bg-opacity-40 bg-black fixed w-full text-white z-10">
      <div className="container flex justify-between h-16 mx-auto">
        ...
        <ul className="items-stretch hidden space-x-3 lg:flex">
          <li className="flex">
            <NavLink
              to="/home"
              className="flex items-center px-4 -mb-1 border-b-2 border-transparent text-violet-600 border-violet-600 text-white text-lg"
          ...
          <li className="flex">
            <NavLink
              to="/news"
              className="flex items-center px-4 -mb-1 border-b-2 border-transparent text-white text-lg"
              activeClassName="border-b-2 border-white"
            >
              Tin tức
            </NavLink>
        ...
        <div className="item-center flex-shrink-0 hidden lg:flex">
          <button onClick={() => {
            history.push('/login')
